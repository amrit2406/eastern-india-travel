...
export default function BookingPage() {
  ...
  const handleSubmit = (e) => {
    ...
    const message = `Hello Eastern India Travels,%0A
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-yellow-300 via-yellow-100 to-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold text-yellow-800 mb-6 tracking-tight leading-tight">
            Book Your <span className="text-yellow-600">Eastern India Adventure</span>
          </h1>
          <p className="text-lg md:text-xl text-yellow-900 font-light max-w-2xl mx-auto leading-relaxed">
            Easy, secure, and personalized tour booking for your next journey in Eastern India.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-xl p-8 md:p-10 transform transition-all duration-300 hover:-translate-y-2">
              <h2 className="text-3xl font-bold text-yellow-800 mb-2">Book Your Adventure</h2>
              <p className="text-yellow-700 mb-8">Fill in the details below to start your journey</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="flex flex-col">
                    <label className="text-sm font-medium text-yellow-800 mb-2">Tour / Package</label>
                    <input
                      type="text"
                      name="tour"
                      required
                ...
                {/* Message */}
                <div className="flex flex-col">
                  <label className="text-sm font-medium text-yellow-800 mb-2">Additional Details</label>
                  <textarea
                    name="message"
                    value={form.message}
                    onChange={handleChange}
          ...
          <div className="col-span-1 lg:col-span-1">
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-xl p-6 sm:p-8 h-full transform transition-all duration-300 hover:-translate-y-2">
              <div className="flex flex-col items-center text-center mb-6 sm:mb-8">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-yellow-800">Need Assistance?</h3>
                <p className="text-yellow-700 mt-2 text-sm sm:text-base">Our team is here to help</p>
              </div>
              ...
              <div className="space-y-5 sm:space-y-6">
                ...
                <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-2 sm:mb-3">
                    ...
                    <h4 className="font-bold text-yellow-800 text-sm sm:text-base">Call Us</h4>
                  </div>
                  <p className="text-yellow-900 font-medium text-sm sm:text-base">+91 9337124745</p>
                  <p className="text-yellow-900 font-medium text-sm sm:text-base">+91 8456840041</p>
                  <p className="text-yellow-700 text-xs sm:text-sm mt-1">Mon-Sat: 9am-7pm</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-2 sm:mb-3">
                    ...
                    <h4 className="font-bold text-yellow-800 text-sm sm:text-base">WhatsApp</h4>
                  </div>
                  <p className="text-yellow-900 font-medium text-sm sm:text-base">+91 9337124745</p>
                  <p className="text-yellow-900 font-medium text-sm sm:text-base">+91 8456840041</p>
                  <p className="text-yellow-700 text-xs sm:text-sm mt-1">Available 24/7</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-2 sm:mb-3">
                    ...
                    <h4 className="font-bold text-yellow-800 text-sm sm:text-base">Email Us</h4>
                  </div>
                  <p className="text-yellow-900 font-medium text-sm sm:text-base break-words">
                    info@easternindiatravels.com
                  </p>
                  <p className="text-yellow-700 text-xs sm:text-sm mt-1">Response within 24 hours</p>
                </div>
              </div>
              ...
              <div className="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-yellow-200">
                ...
                <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                  <li className="flex items-start">
                    ...
                    <span className="text-yellow-900">Flexible payment & cancellation options</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-yellow-500 flex items-center justify-center flex-shrink-0 mt-0.5 mr-2">
                      <FaCheckCircle className="text-white text-[10px] sm:text-xs" />
                    </div>
                    <span className="text-yellow-900">All bookings confirmed by email & phone</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-yellow-500 flex items-center justify-center flex-shrink-0 mt-0.5 mr-2">
                      <FaCheckCircle className="text-white text-[10px] sm:text-xs" />
                    </div>
                    <span className="text-yellow-900">Support team helps with itinerary & travel docs</span>
                  </li>
                </ul>
              </div>
            </div>
