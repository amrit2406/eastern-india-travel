...
import { FaEnvelope, FaPhoneAlt, FaMapMarkerAlt, FaFacebookF, FaInstagram, FaTwitter, FaPaperPlane, FaClock } from "react-icons/fa";
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-yellow-300 via-yellow-100 to-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold text-yellow-800 mb-6 tracking-tight leading-tight">
            Contact <span className="text-yellow-600">Eastern India Travels</span>
          </h1>
          <p className="text-lg md:text-xl text-yellow-900 font-light max-w-2xl mx-auto leading-relaxed">
            Reach out for custom trips, inquiries, and support. Our team is here to make your Eastern India journey seamless and memorable.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-lg p-8 transform transition-all duration-300 hover:-translate-y-2">
              <h2 className="text-3xl font-bold text-yellow-800 mb-8">Contact Information</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-yellow-800 text-lg">Our Location</h3>
                    <p className="text-yellow-900 mt-1">Plot no - 1934/6866, Kishan Nagar, Satya Vihar, Rasulgarh, Bhubaneswar, Odisha 751010</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-yellow-800 text-lg">Phone Number</h3>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-yellow-800 text-lg">Email Address</h3>
                    <p className="text-yellow-900 mt-1">info@easternindiatravels.com</p>
                  </div>
                </div>
              </div>
              
              <div className="mt-10">
                <h3 className="font-bold text-yellow-800 text-lg mb-4">Follow Us</h3>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-lg p-8">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="font-bold text-yellow-800 text-xl">Office Hours</h3>
              </div>
          ...
          {/* Contact Form */}
          <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-lg p-8 transform transition-all duration-300 hover:-translate-y-2">
            <h2 className="text-3xl font-bold text-yellow-800 mb-2">Send Us a Message</h2>
            <p className="text-yellow-700 mb-8">Have questions? We'd love to hear from you.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="relative">
                ...
                />
                <label 
                  className={`absolute left-4 transition-all duration-300 ${focused.name || form.name ? 'text-yellow-600 text-xs top-2' : 'text-yellow-700 top-4'}`}
                >
                  Your Name
                </label>
              </div>
              ...
              <div className="relative">
                ...
                />
                <label 
                  className={`absolute left-4 transition-all duration-300 ${focused.email || form.email ? 'text-yellow-600 text-xs top-2' : 'text-yellow-700 top-4'}`}
                >
                  Your Email
                </label>
              </div>
              ...
              <div className="relative">
                ...
                />
                <label 
                  className={`absolute left-4 transition-all duration-300 ${focused.message || form.message ? 'text-yellow-600 text-xs top-2' : 'text-yellow-700 top-4'}`}
                >
                  Your Message
                </label>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20">
        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-lg p-8">
          <h2 className="text-3xl font-bold text-yellow-800 mb-6 text-center">Find Us on the Map</h2>
          <div className="rounded-xl overflow-hidden shadow-md h-96 bg-yellow-200 flex items-center justify-center">
            <div className="text-center p-8">
              <FaMapMarkerAlt className="text-yellow-700 text-5xl mx-auto mb-4" />
              <h3 className="text-2xl font-bold text-yellow-800 mb-2">Eastern India Travels</h3>
