...
export default function GalleryPage() {
  ...
  return (
    <main className="bg-white min-h-screen">
      {/* Gallery Hero */}
      <section className="relative pt-32 pb-16 bg-gradient-to-br from-yellow-300 via-yellow-100 to-white overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold text-yellow-800 mb-6 tracking-tight leading-tight">
            Eastern India <span className="text-yellow-600">Gallery</span>
          </h1>
          <p className="text-lg md:text-xl text-yellow-900 font-light max-w-2xl mx-auto leading-relaxed">
            A glimpse into the sights, colors, and adventures of Eastern India, captured through our travelers' lens.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20 mt-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {filteredImages.map((image, index) => (
            <div 
              key={image.id} 
              className="relative overflow-hidden rounded-xl shadow-lg group cursor-pointer transform transition-all duration-500 hover:-translate-y-2 hover:shadow-xl"
